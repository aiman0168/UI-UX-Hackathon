...
const RecommentionCard: React.FC<Product> = ({ image, name, description, numberofpeople, liters, price, oldPrice, discount, showDiscount }) => {
  return (
    <div className="w-full sm:w-[304px] md:w-[304px] lg:w-[304px] h-[388px] bg-white rounded-lg relative overflow-hidden" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
